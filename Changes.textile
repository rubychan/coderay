...
* *FIXED* several token kinds had no associated color ("#139":http://redmine.rubychan.de/issues/139)
* *FIXED* strings are closed correctly ("#138":http://redmine.rubychan.de/issues/138)
* *NEW* alias @terminal@
  
  It will be renamed to @Encoders::Terminal@ in the next release.
